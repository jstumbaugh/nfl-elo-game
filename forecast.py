...
HFA = 59.0     # Home field advantage is worth 59 Elo points
K = 21.0       # The speed at which Elo ratings change
REVERT = 0.34  # Between seasons, a team retains 68% of its previous season's rating
